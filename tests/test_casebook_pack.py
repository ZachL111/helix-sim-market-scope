"""Regression checks for the helix-sim-market-scope casebook."""
...
from casebook.harness import assert_expected, helix_sim_market_scope_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(helix_sim_market_scope_summary(), assert_expected())
